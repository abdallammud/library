...
$pdf->SetTitle('Customer Transactions Report');
$pdf->SetSubject('Customer Transactions Report');
...
// Add Logo
$pdf->Image('./assets/images/logo.png', 125, 5, 50);
...
$pdf->SetXY(15, 45);
$pdf->Cell(0, 10, $lang['pdf_customer_transactions_report'], 0, 1, 'C');
...
// Output the PDF
$pdf->Output($lang['pdf_customer_transactions_report'] . ".pdf", 'I');
?>
