...
// Create instance of mypdf
$pdf = new MYPDF('L', 'mm', 'A4'); // 'L' for landscape orientation

// Set document information
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('Author Name');
$pdf->SetTitle($lang['pdf_books_checked_out_report']);
$pdf->SetSubject('Books Checked Out Report');
...
$pdf->SetXY(15, 45);
$pdf->Cell(0, 10, $lang['pdf_books_checked_out_report'], 0, 1, 'C');
...
// Output the PDF
$pdf->Output($lang['pdf_books_checked_out_report'] . ".pdf", 'I');
?>
